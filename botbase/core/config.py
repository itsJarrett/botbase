...
class Value:
    ...
    driver : `botbase.core.drivers.red_base.BaseDriver`
...
class Config:
    ...
    unique_identifier : `int`
        ...
        conflicts occur.
    driver
        An instance of a driver that implements `botbase.core.drivers.red_base.BaseDriver`.
    force_registration : `bool`
    ...
    def guild(self, guild: discord.Guild) -> Group:
        ...
        Returns
        -------
        `Group <botbase.core.config.Group>`
