...
class RedBase(BotBase, RPCMixin):
    ...
    def unload_extension(self, name):
        ...
        try:
            ...
            if pkg_name.startswith("botbase.cogs."):
                del sys.modules["botbase.cogs"].__dict__[name]
        ...
        for attr in dir(cog):
            ...
            if isinstance(_attr, discord.ext.commands.Command) and not isinstance(
                ...
                raise RuntimeError(
                    ...
                    "If this is your cog, please use `from botbase.core import commands`"
                    "in place of `from discord.ext import commands`. For more details on "
                    "this requirement, see this page: "
                    "http://botex-discordbot.readthedocs.io/en/v3-develop/framework_commands.html"
                )
        super().add_cog(cog)
