...
import sys
import discord
from botbase.core.bot import Red, ExitCodes
from botbase.core.cog_manager import CogManagerUI
from botbase.core.data_manager import create_temp_config, load_basic_configuration, config_file
from botbase.core.json_io import JsonIO
from botbase.core.global_checks import init_global_checks
from botbase.core.events import init_events
from botbase.core.cli import interactive_config, confirm, parse_cli_flags, ask_sentry
from botbase.core.core_commands import Core
from botbase.core.dev_commands import Dev
...
def init_loggers(cli_flags):
    ...
    from botbase.core.data_manager import core_data_path
...
def list_instances():
    if not config_file.exists():
        print(
            ...
            "using `botbase-setup` before trying to run the bot!"
        )
        sys.exit(1)
    else:
