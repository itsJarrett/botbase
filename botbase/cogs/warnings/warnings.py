...
from botbase.cogs.warnings.helpers import (
    warning_points_add_check,
    get_command_for_exceeded_points,
    get_command_for_dropping_points,
    warning_points_remove_check,
)
from botbase.core import Config, modlog, checks, commands
from botbase.core.bot import Red
from botbase.core.i18n import Translator, cog_i18n
from botbase.core.utils.mod import is_admin_or_superior
from botbase.core.utils.chat_formatting import warning, pagify
