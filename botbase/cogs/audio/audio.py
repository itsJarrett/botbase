...
import time
import botbase.core
from botbase.core import Config, commands, checks, bank
from botbase.core.utils.menus import menu, DEFAULT_CONTROLS, prev_page, next_page, close_menu
...
class Audio:
    ...
    async def settings(self, ctx):
        ...
        jarbuild = botbase.core.__version__
